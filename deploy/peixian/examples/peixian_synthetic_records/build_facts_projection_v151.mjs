...
const data=JSON.parse(await readFile(new URL('../../../../services/peixian-control/control/scenario_data_v151.json',import.meta.url),'utf8'));
const tables=[];
...
await writeFile(new URL('../../../../services/peixian-control/control/scenario_fact_tables_v151.json',import.meta.url),JSON.stringify(tables,null,2)+'\n');
