const METHOD="GET", PATH="/system/multiDimension/logs/";
export default async function plugin(_context,_options,platform) {
 return {tool:{peixian_query_warning_logs:{description:"读取已确认范围的来源预警明细。条件由平台冻结，无需参数。",args:{},async execute(args){
