...
ALLOWED_FILES = (
    ...
    'deploy/peixian/examples/peixian_synthetic_records/presentation-plugin/manifest.json',
    'deploy/peixian/examples/peixian_synthetic_records/presentation-plugin/engine.mjs',
    'deploy/peixian/examples/peixian_synthetic_records/presentation-plugin/fixtures.json',
    'deploy/peixian/examples/peixian_synthetic_records/presentation-plugin/legacy.mjs',
    'deploy/peixian/examples/peixian_synthetic_records/presentation-plugin/entry.mjs',
    'deploy/peixian/examples/peixian_synthetic_records/presentation-plugin.test.mjs',
    'deploy/peixian/examples/peixian_synthetic_records/presentation_acceptance.py',
    "deploy/peixian/PRESENTATION_ALIGNMENT_ACCEPTANCE.md",
    "LICENSE",
    ...
    "deploy/peixian/server/platform.on-demand.example.json",
    ...
    "services/peixian-control/shared/runtime_pool_config.py",
    "deploy/peixian/PR7A_CONTRACT.md",
    "deploy/peixian/PR7A_OPERATIONS.md",
    ...
    "deploy/peixian/reports/n3-local-smoke.json", "deploy/peixian/reports/n3-local-events.json",
    ...
    "deploy/peixian/R3_LOCAL_OPERATIONS.md", "deploy/peixian/reports/R3_LOCAL_REPORT.md",
    "deploy/peixian/r3-local-check.py", "deploy/peixian/r3-revocation-check.py", "deploy/peixian/r3-restart-check.py",
    ...
    "deploy/peixian/n1-local-lifecycle.py",
    "deploy/peixian/reports/n1-local-check.json", "deploy/peixian/reports/n1-local-check-02.json",
    "deploy/peixian/reports/n1-gateway-restart.json", "deploy/peixian/reports/n1-final-gateway.json",
    "deploy/peixian/reports/n1-control-lifecycle.json", "deploy/peixian/reports/n1-control-lifecycle-02.json",
    "deploy/peixian/reports/n1-image-identity.json", "deploy/peixian/reports/n1-local-smoke.json",
    "deploy/peixian/reports/n1-final-events.json",
...
"""
    ...
    manifest = {"format": 1, "product": "Agent 工作台", "source_commit": full_commit,
                ...
                "control_schema_version": 5 if config_version == 4 else 4, "worker_protocol_version": 2, "runtime_protocol_version": 2,
                "worker_capabilities": ["runtime_pool_v1", "runtime_pool_wait_v1", "idle_activity_v1"] if config_version == 4 else [],
