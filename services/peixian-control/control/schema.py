...
def validate_chain(db,version):
    ...
    from . import migrations_v4,migrations_v5,migrations_v6,migrations_v7,migrations_v8,migrations_v9,migrations_v10
    modules={4:migrations_v4,5:migrations_v5,6:migrations_v6,7:migrations_v7,8:migrations_v8,9:migrations_v9,10:migrations_v10}
